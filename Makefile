...
./srcs/gui/rot_button.c ./srcs/parser/map_parser.c ./srcs/parser/img_parser.c ./srcs/parser/parser2.c ./srcs/graphics/background_and_dot.c \
...
./srcs/graphics/obj_writer.c ./srcs/events/obj_events2.c ./srcs/service/archive.c ./srcs/main.c
